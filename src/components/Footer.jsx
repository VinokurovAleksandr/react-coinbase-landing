...
import spacemen from "../media/spacemen.png";
        ...
        <Foot className="flex column gap"> 
            <div className='upper-footer'>
                <div className="flex column gap-1">
                    <div className="brand">
                    <h2 className="brand">Coinbase</h2>
                    </div>
                    <div className="address">
                    <p>GymVast, 18 East 50th Street, 4th Floor, New York, NY 10022</p>
                </div>
                <div className="info">
                    <span>Tel : +1-202-555-0184</span>
                    <span>Email : hello@cryptoz.com</span>
                </div>
            ...
            <div className="lower-footer flex a-center j-between gap">
                <div className="col1">
                    <span>&copy; Crypto a Theme by Santel</span>
                </div>
